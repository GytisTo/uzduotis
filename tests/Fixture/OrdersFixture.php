...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        'orders_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        'value' => ['type' => 'smallinteger', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'customers_id' => ['type' => 'index', 'columns' => ['customers_id'], 'length' => []],
            'products_id' => ['type' => 'index', 'columns' => ['products_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['orders_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
